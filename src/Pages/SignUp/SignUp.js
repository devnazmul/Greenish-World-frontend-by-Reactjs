...
const SignUp = () => {
  ...
  return (
    <>
    <Header />
    <div className="SignUp pt-32 pb-10 flex justify-center items-center text-black h-screen bg-gray-300 px-4">
      <div className="w-full md:w-1/2 flex">
        <div
          onSubmit={handleRegistration}
          className="bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md"
        >
          <form>
            ...
            <div className="relative mb-4 text-left">
              ...
              <input
                ...
                id="username"
                name="username"
                className="w-full rounded bg-gray-100 border border-borderPrimary focus:border-borderPrimary focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
            <div className="relative mb-4 text-left">
              <label
